  ...
  return (
    <div className="h-full flex items-center justify-center min-h-screen bg-[#050505]">
      <div className="flex flex-col gap-4 w-full max-w-3xl text-center text-[#ff2a75]">
        ...
        <div className="w-full h-4 border border-[#ff2a75] p-1">
          <div
            className={cn(
              "h-full bg-[#ff2a75]",
              status >= 100 ? "animate-none" : ""
            )}
            style={{
              width: `${status}%`,
            }}
        ...
        <p
          className={cn(
            ...
            status >= 100 ? "animate-pulse" : ""
          )}
        >
          {status >= 100 ? "- Access Granted -" : "Breaching..."}
        </p>
      </div>
    </div>
  );
